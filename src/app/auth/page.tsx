        ...
        <div className="p-4 flex w-full h-full">
          <div className="m-auto max-w-xs w-full">
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col gap-2">
              ...
              <a href={googleLink}>
                <button className="w-full bg-red-600 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline hover:scale-105 transition ease-in-out flex flex-row gap-1">
