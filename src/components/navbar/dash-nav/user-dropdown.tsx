        ...
        >
          ...
          >
            {email && (
              ...
              >
                <button className="my-auto cursor-pointer hover:bg-gray-200 transition-all ease-in-out p-2 whitespace-nowrap">
                  Νέο μαγαζί
                </button>
                <button className="my-auto cursor-pointer hover:bg-gray-200 transition-all ease-in-out p-2">
                  Νέο μαγαζί
                </button>
                <button className="my-auto cursor-pointer hover:bg-gray-200 transition-all ease-in-out p-2">
                  Νέο μαγαζί
